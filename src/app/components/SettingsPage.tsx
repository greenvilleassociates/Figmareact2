...
import { Settings, Plus, Trash2, GitBranch, FolderKanban, Image, RefreshCw, Download, Upload, Users, Edit2, Calendar, Palette } from 'lucide-react';
  ...
  return (
    <div className="flex-1 bg-gray-50 p-12 overflow-auto max-[999px]:text-[9pt]">
      <div className="max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-2xl font-semibold mb-4 flex items-center gap-2">
            <GitBranch className="w-6 h-6 text-[#4CBB17]" />
            GitHub Configuration
          </h2>
          <div className="space-y-4">
            <div>
